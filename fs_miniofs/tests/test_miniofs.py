...
class TestMINIOFS(FSTestCases, unittest.TestCase):
    """Test MINIOFS implementation from dir_path."""
    ...
    def make_fs(self):
        ...
        return MINIOFS(self.bucket_name)
...
@attr("slow")
class TestMINIOFSSubDir(FSTestCases, unittest.TestCase):
    """Test MINIOFS implementation from dir_path."""
    ...
    def make_fs(self):
        ...
        return MINIOFS(self.bucket_name, dir_path="subdirectory")
...
class TestMINIOFSHelpers(unittest.TestCase):
    ...
    def test_upload_args(self):
        s3 = MINIOFS("foo", acl="acl", cache_control="cc")
